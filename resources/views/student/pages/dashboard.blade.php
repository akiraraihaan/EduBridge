        ...
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                    ...
                    <div class="space-y-4">
                        <p class="text-sm text-gray-500">Progress pembelajaran akan ditampilkan di sini</p>
                    </div>
                </div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                    ...
                    <div class="space-y-4">
                        <p class="text-sm text-gray-500">Kursus yang sedang diikuti akan ditampilkan di sini</p>
                    </div>
                </div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                    ...
                    <div class="space-y-4">
                        <p class="text-sm text-gray-500">Daftar tugas akan ditampilkan di sini</p>
                    </div>
                </div>
            </div>
        </div>
