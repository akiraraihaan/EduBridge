    ...
    <div class="min-h-screen py-6 sm:py-8 md:py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md mx-auto space-y-4 sm:space-y-6 md:space-y-8">
            ...
            <div class="text-center animate-fade-in">
                ...
                <img src="{{ asset('img/logo-ori.png') }}" alt="EduBridge Logo" class="h-8 sm:h-10 md:h-12 mx-auto mb-3 sm:mb-4 animate-fade-in-up opacity-70">
                ...
                <form id="loginForm" method="POST" action="{{ route('login') }}" class="space-y-4 sm:space-y-6">
                    ...
                    <div class="space-y-1 sm:space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <x-text-input id="password" class="block w-full pl-10 text-sm sm:text-base" type="password" name="password" required autocomplete="current-password" placeholder="password" />
