                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('mentor.assignments.store') }}" class="space-y-6">
                        ...
                        <div class="flex items-center">
                            <input id="is_final_project" name="is_final_project" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" {{ old('is_final_project') ? 'checked' : '' }}>
